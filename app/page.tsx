...
const faqItems = [
  ...
  },
  {
    ...
    a: "Filing status determines your tax bracket thresholds and standard deduction. Married filing jointly gets a $32,200 standard deduction (2026) versus $16,100 for single filers, meaning married couples shelter more income from federal tax. Head of household gets a $24,150 deduction. For the same gross salary, a married filer will typically take home more than a single filer.",
  },
];
    ...
    <>
      ...
      >
        <div className="max-w-2xl mx-auto px-4 py-4 flex items-center justify-between">
          <a href="/" className="font-display font-bold text-lg tracking-tight flex items-center gap-2" style={{ color: "var(--text-primary)", textDecoration: "none" }}>
      ...
      <footer className="mt-16 border-t" style={{ borderColor: "var(--border)" }}>
        <div className="max-w-2xl mx-auto px-4 py-8 text-sm" style={{ color: "var(--text-muted)" }}>
          ...
          <p className="mt-3 text-xs">
            ...
            {" · "}
            <a href="https://www.youtube.com/@CalcMoney" target="_blank" rel="noopener noreferrer" style={{ color: "#22C55E", textDecoration: "none" }}>YouTube</a>
          </p>
        </div>
      </footer>
    </>
