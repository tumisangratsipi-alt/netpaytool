  ...
  const faqJsonLd = {
    ...
    mainEntity: [
      ...
      },
      {
        ...
        acceptedAnswer: {
          "@type": "Answer",
          text: `On a ${gross} salary, a single filer pays approximately ${formatCurrencyFull(single.federalTax)} in federal income tax, an effective federal rate of ${formatPercent(single.effectiveFederalRate)}. Married filers pay ${formatCurrencyFull(married.federalTax)} due to the higher standard deduction of $29,200.`,
        },
      },
      {
        "@type": "Question",
      ...
      <main className="max-w-2xl mx-auto px-4 py-10 flex-1">
        ...
        <section className="mb-10">
          ...
          <p className="text-xs mt-2" style={{ color: "var(--text-muted)" }}>
            Based on IRS 2024 tax brackets and standard deductions. State tax calculated at the {name} effective rate of {hasStateTax ? formatPercent(stateRate) : "0% (no state income tax)"}.
          </p>
        </section>
          ...
          <div className="space-y-4">
            {[
              ...
              },
              {
                ...
                a: `On a ${gross} salary, a single filer pays ${formatCurrencyFull(single.federalTax)} in federal income tax, an effective federal rate of ${formatPercent(single.effectiveFederalRate)}. Married filers pay ${formatCurrencyFull(married.federalTax)} because the married standard deduction is $29,200 versus $14,600 for single filers.`,
              },
              {
